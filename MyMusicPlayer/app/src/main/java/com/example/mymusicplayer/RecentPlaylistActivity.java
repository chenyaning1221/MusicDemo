...
public class RecentPlaylistActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recent_playlist);
        ...
        if (actionBar != null) {
            ...
            actionBar.setTitle(R.string.title_recent_playlist);
        }

//        initMusic();//取音乐数据放入List中
        RecyclerView recyclerView = (RecyclerView) findViewById(R.id.recent_music_list);
